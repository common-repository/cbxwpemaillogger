                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[improvement] Latest WordPress 6.3.1 compatible</strong></li>
                                    <li><strong>[improvement] PHP 8.x support</strong></li>
                                    <li><strong>[improvement] Setting page first time render fixed</strong></li>
                                    <li><strong>[improvement] Restructure of hooks loading</strong></li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
