 ...
 * @see   wc_get_template
 */
function cbxwpemaillogger_get_template_html( $template_name, $args = [], $template_path = '', $default_path = '' ) {
	ob_start();
 ...
 * @param  string  $default_path  Default path. (default: '').
 */
function cbxwpemaillogger_get_template( $template_name, $args = [], $template_path = '', $default_path = '' ) {
