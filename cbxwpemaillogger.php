...
defined( 'CBXWPEMAILLOGGER_PLUGIN_VERSION' ) or define( 'CBXWPEMAILLOGGER_PLUGIN_VERSION', '2.0.1' );
...
function run_cbxwpemaillogger() {
	return CBXWPEmailLogger::instance();
}//end function run_cbxwpemaillogger

$GLOBALS['cbxwpemaillogger'] = run_cbxwpemaillogger();